...
barcode.addEventListener('click', () => {
    ...
    function Scan(first) {
        ...
        if (loopflg) {
            ...
            if ((searchline - ((w - (w * ScanRate[0])) / 2)) + searchlinemove > (w * ScanRate[0])) {
                if ((searchline - ((w - (w * ScanRate[0])) / 2)) < (w * ScanRate[0])) {
                    searchline += ((w * ScanRate[0]) - (searchline - ((w - (w * ScanRate[0])) / 2)));
                } else {
